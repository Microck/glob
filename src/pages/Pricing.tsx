        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl relative z-10">
          <div className="bg-surface border-3 border-muted p-8 flex flex-col h-full shadow-brutal overflow-hidden relative">
            ...
            <ul className="flex-1 space-y-4 mb-8 relative z-10">
              ...
              {userId ? (
                <div className="w-full bg-surface border-3 border-muted text-muted font-ui text-sm py-3 text-center transition-none font-bold uppercase relative z-10 opacity-50">
                  Current Plan
                </div>
              ) : (
                <Link to="/signup" className="w-full bg-active text-surface font-ui text-sm py-3 text-center hover:bg-reading transition-none font-bold uppercase relative z-10">
                  Sign Up / Login
                </Link>
              )}
          ...
          <div 
            ...
            style={{ 
              background: `
                ...
                linear-gradient(135deg, rgba(52, 45, 57, 0.2) 0%, transparent 100%),
                #332D3B
              `
            }}
          >
