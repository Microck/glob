      ...
      <div className="flex flex-col items-center w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl relative z-10">
          ...
          <div 
            ...
            style={{ 
              background: `
                radial-gradient(circle at 90% 10%, ${glowColor}${Math.floor(glowIntensity * 255).toString(16).padStart(2, '0')} 0%, transparent 60%),
        ...
        <div className="mt-8 p-6 bg-surface border-3 border-muted grid grid-cols-2 md:grid-cols-5 gap-x-8 gap-y-4 z-20 shadow-brutal max-w-6xl w-full">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input type="range" min="10" max="200" step="1" value={patternSize} onChange={(e) => setPatternSize(Number(e.target.value))} className="accent-active" />
          </div>
          <div className="flex flex-col gap-1">
